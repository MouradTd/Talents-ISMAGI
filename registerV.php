...
if (isset($_POST['submit']) || isset($_POST['pimg'])) {
    ...
    if (mysqli_num_rows($sql) > 0) {
        ...
        if ($password != $cpassword) {
            ...
            $query =  "INSERT INTO `users` (username,email,description,password,user_level,img) VALUES( '$username','$mail','$description','$password',1,'$img_folder')";
            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto my-4">
                <div class="card my-5">
                    <div class="card-body p-5">
                        <h4 class="fw-bold"> create your Student Account 🔥</h4>
                  ...
                  ";
                        ...
                        <form method="post" class="needs-validation" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                <input type="email" class="form-control form-control-md" id="validationEmail" placeholder="Email" required name="email">
                                <div class="invalid-feedback animate__animated animate__headShake">
                            ...
                            <textarea type="text" class="form-control " placeholder="description" name="description"  required></textarea>
                                ...
                                <div class="invalid-feedback animate__animated animate__headShake">
                                    <i class="bi bi-exclamation-circle-fill pe-1 pt-2"></i>Please input your Description
                                </div>
                                <div class="valid-feedback animate__animated animate__bounceIn">
                                    <i class="bi bi-check-circle-fill pe-1 pt-2"></i>
                                    Looks good!
