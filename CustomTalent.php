...
if (!isset($_SESSION["username"]) || !isset($_SESSION["id_user"])) {
    ...
    if (isset($_POST['submit'])) {
        $talent_name = mysqli_real_escape_string($con, $_POST['talent_name']);
        $description = mysqli_real_escape_string($con, $_POST['description']);
        $talent_owner = mysqli_real_escape_string($con, $_POST['talent_owner']);
        $sql = mysqli_query($con, "SELECT * FROM `custom` WHERE talent_name ='$talent_name' AND description= '$description' AND talent_owner = '$talent_owner' ");
        if (mysqli_num_rows($sql) > 0) {
            $message[] = ' Talent Already exists in DB';
        } else {

            $query =  "INSERT INTO `custom` (client_name,talent_name,talent_owner,description,status) VALUES( '" . $_SESSION["username"] . "', '$talent_name','$talent_owner','$description','Pending' )";
                ...
                <div class="row">
                  ...
                  ";
                        ...
                        <div class="form-group">
                            <label for="choices">Student Name :</label>
                            <select class="choices form-select" name="talent_owner">
                                <?php
                                $sql = mysqli_query($con, "SELECT username FROM `users` WHERE user_level = '1' ");
                                if (mysqli_num_rows($sql) > 0) {
                                    foreach ($sql as $res) {
                                ?>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="first-name-vertical" class="form-control" name="talent_name" id="talent_name" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea type="text" id="password-vertical" class="form-control" id='desciption' name="description"></textarea>
                        </div>
                    </div>
