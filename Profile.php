...
if (isset($_POST['Update_Profile'])) {
    ...
    $query =  "UPDATE `users` SET username = '$username', email ='$mail' ,description = '$description'  , img = '$updated_img_folder'  WHERE id = '" . $_SESSION['id_user'] . "' ";
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="form-group mb-4">
                                            <label for="about" class="text-secondary-700 mb-2">Description :</label>
                                            <textarea type="text" class="form-control " placeholder="<?= $result['description']; ?>" name="description" id="description" required></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group float-end">
